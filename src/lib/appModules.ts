...
const PEOPLE_TILES: ModuleTile[] = [
  {
    ...
    hintEn: 'People & HR — employees, recruitment, time off, payroll',
    hintSw: 'Watu & HR — wafanyakazi, kuajiri, likizo, mishahara',
    icon: UserCog,
...
const FINANCE_TILES: ModuleTile[] = [
  {
    ...
    labelEn: 'Accounting',
    labelSw: 'Uhasibu',
    hintEn: 'Accounting dashboard, P&L, balance sheet, TRA/VAT books',
    hintSw: 'Dashibodi uhasibu, mapato, mizania, vitabu TRA/VAT',
    icon: FileText,
    accent: 'bg-[#0078D4]',
  },
  {
    ...
    labelEn: 'Reports',
    labelSw: 'Ripoti',
    hintEn: 'Standard A4 reports + TRA fiscal reports & receipt register',
    hintSw: 'Ripoti A4 + ripoti TRA na daftari la risiti',
    icon: BarChart3,
    accent: 'bg-blue-500',
  },
  {
...
export function buildAppModules(businessType: BusinessType): AppModule[] {
  return [
    ...
    },
    {
      ...
      labelEn: 'Operations',
      labelSw: 'Shughuli',
      hintEn: 'Workplace, branches, and documents',
      hintSw: 'Kazi, matawi, na nyaraka',
      icon: Compass,
